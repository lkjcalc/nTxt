...
char* getline(char* textbuffer, int pos, int cursorscreenrow){//returns pointer to first character of screen where position is in row=cursorscreenrow on screen
